            ...
            <div class="col-md-9">
                <form action method="post" id="regForm">
                    ...
                    <div class="tab">
                        <h6>To Path</h6>
                        <p>
                            <input placeholder="C:\dir..." class="input-custom" name="path" value="<?= query('address') ?>"></p>

                    </div>
                    <div style="overflow:auto;" id="nextprevious">
                        <div style="float:right;">
                            <a type="button" class="btn-custom cancel text-white mr-2" href="/?address=<?=$parent?>" ><i class="fa fa-times"></i></a>
